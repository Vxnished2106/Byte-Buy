...
export function Discover(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      {...props}
    ...
    >
      ...
      <defs>
        ...
        <path
          id="SVGYiLlGcjR"
          d="M270.356.365c-23.982 0-43.44 18.735-43.44 41.857c0 24.584 18.613 42.96 43.44 42.96c24.208 0 43.322-18.62 43.322-42.477c0-23.716-18.986-42.34-43.322-42.34"
        />
      </defs>
      <use fill="url(#SVGcvTIXKbo)" fill-rule="evenodd" href="#SVGYiLlGcjR" />
      <use filter="url(#SVG78rrJTul)" href="#SVGYiLlGcjR" />
      <path
        fill="#0b1015"
